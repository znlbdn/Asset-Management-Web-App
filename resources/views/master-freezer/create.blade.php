...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Freezer</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action='{{ url('master-freezer') }}' method='post'>
                @csrf
                <div class="my-3 p-3 bg-body rounded shadow-sm">
                    <div class="mb-3 row">
                        <label for="key_number" class="col-sm-2 col-form-label">Key Number</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='key_number' id="key_number" value="{{ Session::get('key_number') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="freezer_owner" id="freezer_owner" class="form-control" required>
                                <option value="{{ Session::get('freezer_owner') }}">Pilih Freezer Owner...</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="supplier" id="supplier" class="form-control" required>
                                <option value="{{ Session::get('supplier') }}">Pilih Supplier Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="brand" id="brand" class="form-control" required>
                                <option value="{{ Session::get('brand') }}">Pilih Brand Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='batch_po' id="batch_po" value="{{ Session::get('batch_po') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="type" id="type" class="form-control" required>
                                <option value="{{ Session::get('type') }}">Pilih Type/Volume Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='barcode' id="barcode" value="{{ Session::get('barcode') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
