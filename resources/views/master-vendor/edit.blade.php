...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action='{{ url('master-vendor/'.$data -> kode_vendor) }}' method='post'>
                @csrf
                @method("PUT")
                <div class="my-3 p-3 bg-body rounded shadow-sm">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="kode_vendor" id="kode_vendor" value="{{ $data -> kode_vendor }}" readonly>
                            {{-- {{ $data -> kode_vendor }} --}}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='nama_vendor' id="nama_vendor" value="{{ $data -> nama_vendor }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="npwp" class="col-sm-2 col-form-label">No NPWP</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='npwp' id="npwp" value="{{ $data -> npwp }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="pic" class="col-sm-2 col-form-label">Nama PIC</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='pic' id="pic" value="{{ $data -> pic }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="hp" class="col-sm-2 col-form-label">Nomor HP</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='hp' id="hp" value="{{ $data -> hp }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
