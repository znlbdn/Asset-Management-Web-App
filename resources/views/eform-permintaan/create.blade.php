...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h3 mb-0 text-gray-800">Tambah Permintaan Freezer</h1>
    </div>
        ...
        <div class="card-header py-3">
            <div class="d-sm-flex align-items-center justify-content-between">
                <a href="{{ url('eform-permintaan') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                    ...
                    Kembali ke E-form Permintaan
                </a>
            </div>
        </div>
        <div class="card-body">
            @include('component/message')
            <form action='{{ url('eform-permintaan') }}' method='post'>
                @csrf
                <div class="my-3 p-3 bg-body rounded shadow-sm">
                    <div class="mb-3 row">
                        <label for="req_no" class="col-sm-2 col-form-label">Nomor Permintaan</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='req_no' id="req_no" value="{{ Session::get('req_no') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="req_date" class="col-sm-2 col-form-label">Tanggal Permintaan</label>
                        <div class="col-sm-10">
                            <input type="datetime-local" class="form-control" name='req_date' id="req_date" value="{{ Session::get('req_date') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="req_name" class="col-sm-2 col-form-label">Nama Pemohon</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='req_name' id="req_name" value="{{ Session::get('req_name') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="req_hp" class="col-sm-2 col-form-label">Nomor HP Pemohon</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='req_hp' id="req_hp" value="{{ Session::get('req_hp') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="req_vendor" class="col-sm-2 col-form-label">Asal Vendor</label>
                        <div class="col-sm-10">
                            <select name="req_vendor" id="req_vendor" class="form-control">
                                <option value="{{ Session::get('req_vendor') }}">Pilih Vendor Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        <label for="req_type" class="col-sm-2 col-form-label">Type Freezer</label>
                        <div class="col-sm-10">
                            <select name="req_type" id="req_type" class="form-control">
                                <option value="{{ Session::get('req_type') }}">Pilih Type Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        <label for="req_size" class="col-sm-2 col-form-label">Ukuran Frezer</label>
                        <div class="col-sm-10">
                            <select name="req_size" id="req_size" class="form-control">
                                <option value="{{ Session::get('req_size') }}">Pilih Type/Volume Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        <label for="req_total" class="col-sm-2 col-form-label">Jumlah Freezer</label>
                        <div class="col-sm-10">
                            <input type="int" class="form-control" name='req_total' id="req_total" value="{{ Session::get('req_total') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
