...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h3 mb-0 text-gray-800">Tambah Pengembalian Freezer</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action='{{ url('eform-pengembalian') }}' method='post'>
                @csrf
                <div class="my-3 p-3 bg-body rounded shadow-sm">
                    <div class="mb-3 row">
                        <label for="ret_no" class="col-sm-2 col-form-label">Nomor Pengembalian</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='ret_no' id="ret_no" value="{{ Session::get('ret_no') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="ret_date" class="col-sm-2 col-form-label">Tanggal Pengembalian</label>
                        <div class="col-sm-10">
                            <input type="datetime-local" class="form-control" name='ret_date' id="ret_date" value="{{ Session::get('ret_date') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="ret_kode" class="col-sm-2 col-form-label">Kode Freezer</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='ret_kode' id="ret_kode" value="{{ Session::get('ret_kode') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="ret_back" class="col-sm-2 col-form-label">Tujuan Pengembalian</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='ret_back' id="ret_back" value="{{ Session::get('ret_back') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="ret_type" id="ret_type" class="form-control" required>
                                <option value="{{ Session::get('ret_type') }}">Pilih Type Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="ret_size" id="ret_size" class="form-control" required>
                                <option value="{{ Session::get('ret_size') }}">Pilih Ukuran Freezer...</option>
