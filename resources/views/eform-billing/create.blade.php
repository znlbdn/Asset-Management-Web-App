...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h3 mb-0 text-gray-800">Tambah Billing Freezer</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action='{{ url('eform-billing') }}' method='post'>
                @csrf
                <div class="my-3 p-3 bg-body rounded shadow-sm">
                    <div class="mb-3 row">
                        <label for="bil_no" class="col-sm-2 col-form-label">Nomor Billing</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='bil_no' id="bil_no" value="{{ Session::get('bil_no') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="bil_date" class="col-sm-2 col-form-label">Tanggal Billing</label>
                        <div class="col-sm-10">
                            <input type="datetime-local" class="form-control" name='bil_date' id="bil_date" value="{{ Session::get('bil_date') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="bil_code" class="col-sm-2 col-form-label">Kode Freezer</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='bil_code' id="bil_code" value="{{ Session::get('bil_code') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="bil_vendor" id="bil_vendor" class="form-control" required>
                                <option value="{{ Session::get('bil_vendor') }}">Pilih Vendor Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="bil_type" id="bil_type" class="form-control" required>
                                <option value="{{ Session::get('bil_type') }}">Pilih Type Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="bil_size" id="bil_size" class="form-control" required>
                                <option value="{{ Session::get('bil_size') }}">Pilih Type/Volume Freezer...</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='bil_total' id="bil_total" value="{{ Session::get('bil_total') }}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
